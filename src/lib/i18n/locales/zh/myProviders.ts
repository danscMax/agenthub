export default {
  ...
  connectVia: '连接方式',
  connectViaHint: '通过 freellmapi — 适用于普通供应商（DeepSeek、Minimax）。直接 — 仅限 Anthropic 原生。',
  viaFreellmapi: '通过 freellmapi',
  viaDirect: '直接',
  targetProfile: '目标配置',
  targetProfilePlaceholder: '— 选择配置 —',
  openaiNeedsRouter:
    'OpenAI 供应商直连需要 claude-code-router（当前不可用）。请选择“通过 freellmapi”。',
  model: '模型',
  apiKey: 'API 密钥',
